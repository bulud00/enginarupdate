...
A big chunk (%70) of this plugin was generated by Claude Sonnet 5. Every single line was reviewed.
...
**Blazes now spawn naturally outside of Nether Fortresses.** Vanilla Blazes are 100% fortress-spawner-bound; they never appear via ambient biome spawning. The bundled 
datapack adds a `minecraft:blaze` natural spawn entry to three Nether biomes:
